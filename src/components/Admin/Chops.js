...
function Chops() {
  ...
  React.useEffect(() => {
    dispatch(Actions.getProduct("chops"));
  }, []);
  ...
  return (
    <div className="px-6 py-8 flex-col">
      ...
      <Typography style={{ display: "table", float: 'left' }} variant="h3" className="">Chops</Typography>
...
export default withReducer('products', reducer)(Chops);
