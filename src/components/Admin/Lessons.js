...
function Lessons() {
  ...
  React.useEffect(() => {
    dispatch(Actions.getProduct("lessons"));
  }, []);
  ...
  return (
    <div className="px-6 py-8 flex-col">
      ...
      <Typography style={{ display: "table", float: 'left' }} variant="h3" className="">Lessons</Typography>
...
export default withReducer('products', reducer)(Lessons);
