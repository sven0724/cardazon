...
function Services() {
  ...
  React.useEffect(() => {
    dispatch(Actions.getProduct("services"));
  }, []);
  ...
  return (
    <div className="px-6 py-8 flex-col">
      ...
      <Typography style={{ display: "table", float: 'left' }} variant="h3" className="">Services</Typography>
...
export default withReducer('products', reducer)(Services);
