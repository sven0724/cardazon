...
function Spoofing() {
  ...
  React.useEffect(() => {
    dispatch(Actions.getProduct("spoofing"));
  }, []);
  ...
  return (
    <div className="px-6 py-8 flex-col">
      ...
      <Typography style={{ display: "table", float: 'left' }} variant="h3" className="">Spoofing</Typography>
...
export default withReducer('products', reducer)(Spoofing);
