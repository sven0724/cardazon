...
function Tools() {
  ...
  React.useEffect(() => {
    dispatch(Actions.getProduct("tools"));
  }, []);
  ...
  return (
    <div className="px-6 py-8 flex-col">
      ...
      <Typography style={{ display: "table", float: 'left' }} variant="h3" className="">Tools</Typography>
...
export default withReducer('products', reducer)(Tools);
